...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($status == "1") {
            $query = mysqli_query($con, "INSERT INTO tblcity (city) VALUES('$city')");
            if ($query) {
...
?>
    ...
    <head>
        ...
        <!-- App title -->
        <title>Adminportal | Add City</title>
                            ...
                            <div class="col-sm-6" id="hideMe">
                                ...
                                <?php if ($nameError) { ?>
                                    <div class="alert alert-danger alert-dismissible" role="alert">
                                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                        <?php echo htmlentities($nameError); ?>
                                    </div>
                                <?php } ?>
                            </div>
                        </div>
                                    ...
                                    <div class="">
                                        <form name="addpost" method="post" enctype="multipart/form-data">
                                            <div class="form-group m-b-20">
                                                ...
                                                <input type="text" class="form-control" id="city" name="city" placeholder="Enter title" required>
                                            </div>
