         ...
         <div class="content-page">
            ...
            <div class="content">
               <div class="container">
                  <div class="row">
                     <div class="col-lg-12">
                        <h3 class="page-header"><i class="fa fa-laptop"></i> Edit Report</h3>
                     </div>
                  </div>
                  <!-- end row -->
                  <div class="row">
                           ...
                           <div class="card-box">
                              <div class="">
                                 <form name="addpost" method="post" enctype="multipart/form-data">
                                    ...
                                    <button type="submit" name="submit" class="btn btn-success waves-effect waves-light">Update and Post</button>
