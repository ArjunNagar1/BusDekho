...
if($status == "1"){  
$query=mysqli_query($con,"insert into tbltype(type) values('$type')");
if($query)
{
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Adminportal | Add type</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Add Bus type </h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="manage-type.php">Manage</a>
                                        </li>
